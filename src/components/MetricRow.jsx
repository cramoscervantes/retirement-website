...
function MetricRow({ metric, value, whatIfValue, impact }) {
    return (
        <TableRow>
            <TableCell className="py-3 px-4 text-slate-900 dark:text-slate-300">{metric}</TableCell>
            <TableCell className="py-3 px-4 text-blue-500">{value}</TableCell>

            {whatIfValue &&
                <>
                    <TableCell className="py-3 px-4 text-emerald-600">{whatIfValue}</TableCell>
                    <TableCell className="py-3 px-4 text-slate-900 dark:text-slate-300">
                        {impact &&
